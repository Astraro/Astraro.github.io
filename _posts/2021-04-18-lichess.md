...
-	Do we observe a change in shares of time mode? This would indicate a change in the mixture of players playing on Lichess.
...
Analysis:
------------
Now, we have everything prepared to consider the questions given in the introduction. We start with the development over time. The series was published on the 23rd of October. Do we see a significant change in the number of games played daily on Lichess? The answer is definitely yes as the following plot shows.
